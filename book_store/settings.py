...
SECRET_KEY = 'django-insecure-2$a2-&3o2@c!x_3dcj(7qli@&g33^rn=xg&qdd+ga7pxm!#9=q'
...
MEDIA_ROOT = BASE_DIR / 'media'  # The local filesystem path where media files are stored
